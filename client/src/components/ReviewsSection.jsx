    ...
    <div className="mt-6">
      ...
      {showForm && (
        <Card className="p-5 mb-6 border-blue-300 dark:border-blue-500/20">
          ...
          {formError && (
            <div className="bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 text-red-600 dark:text-red-400 px-4 py-2 rounded-lg mb-3 text-sm">
              {formError}
            </div>
          )}
