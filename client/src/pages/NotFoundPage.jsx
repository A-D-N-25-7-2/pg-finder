...
const NotFoundPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-base flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative text-center animate-fade-in">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 -mt-4">Page Not Found</h1>
