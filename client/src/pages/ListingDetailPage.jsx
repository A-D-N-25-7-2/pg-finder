  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-base py-8 px-4">
      <div className="max-w-5xl mx-auto">
        <button
          onClick={() => navigate(-1)}
          className="mb-6 flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-medium transition-colors"
        >
          ← Back to results
        </button>
        ...
        <div className="bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border rounded-2xl overflow-hidden animate-fade-in">
          ...
          <div className="relative">
            <div className="h-72 md:h-96 bg-gray-100 dark:bg-dark-elevated overflow-hidden">
              {listing.images?.length > 0 ? (
                ...
                <div className="w-full h-full flex items-center justify-center text-7xl text-gray-300 dark:text-gray-700">
                  <AppIcon name="home" size={64} />
                </div>
              )}
            </div>
            ...
            {user?.role !== "admin" && (
              <button
                ...
                className={`wishlist-button absolute top-4 right-4 glass rounded-full w-10 h-10 flex items-center justify-center transition-colors ${wishlisted ? "text-red-500" : "text-gray-700 dark:text-gray-200"}`}
              >
                <AppIcon
                  name="wishlist"
                  size={20}
          ...
          <div className="p-6">
            <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4 gap-4">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-500">
                  <AppIcon name="map" size={15} className="inline mr-1" />
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              ...
              <Badge
                status={listing.gender}
                className="bg-purple-100 dark:bg-purple-500/15 text-purple-600 dark:text-purple-400 border-purple-200 dark:border-purple-500/20"
              />
              {listing.averageRating > 0 && (
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-amber-100 dark:bg-amber-500/15 text-amber-600 dark:text-amber-400 border border-amber-200 dark:border-amber-500/20">
                  <AppIcon name="rating" size={14} className="inline mr-1" />
              ...
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-cyan-100 dark:bg-cyan-500/15 text-cyan-600 dark:text-cyan-400 border border-cyan-200 dark:border-cyan-500/20">
                <AppIcon name="view" size={14} className="inline mr-1" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 space-y-6">
                ...
                >
                  <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-2 pb-1 border-b border-gray-200 dark:border-dark-border">
                    About this place
                  </h2>
                ...
                {listing.amenities?.length > 0 && (
                  ...
                  >
                    <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-3 pb-1 border-b border-gray-200 dark:border-dark-border">
                      Amenities
                    </h2>
                    <div className="flex flex-wrap gap-2">
                      {listing.amenities.map((amenity, i) => (
                        <span
                          key={i}
                          className="amenity-tag bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 text-blue-600 dark:text-blue-400 px-3 py-1 rounded-full text-sm font-medium cursor-default"
                ...
                >
                  ...
                  <div className="bg-gray-100 dark:bg-dark-elevated rounded-xl h-48 flex items-center justify-center border border-gray-200 dark:border-dark-border">
                    <div className="text-center text-gray-500 dark:text-gray-500">
                      <AppIcon name="map" size={40} className="mx-auto mb-2" />
                      <p className="font-medium text-gray-600 dark:text-gray-400">
                        {listing.address}
                      </p>
                      <p className="text-sm mt-1">{formatCity(listing.city)}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-dark-elevated border border-gray-200 dark:border-dark-border rounded-xl p-4 text-center">
                  <p className="text-gray-500 dark:text-gray-500 text-sm mb-3 font-medium">
                    Interested in this place?
                  </p>
                  {isAuthenticated && user?.role === "user" ? (
                    <Button
                      onClick={() => navigate(`/listing/${id}/book`)}
                      className="w-full"
                    >
                    ...
                    <p className="text-gray-500 dark:text-gray-600 text-sm bg-gray-100 dark:bg-dark-card rounded-lg p-3">
